...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="COCD_TP146036UK04.Reason", Namespace="urn:hl7-org:v3")]
    public partial class COCD_TP146036UK04Reason {
        
        private TemplateContent contentIdField;
        
        private COCD_TP146036UK04ReasonSeperatableInd seperatableIndField;
        
        private COCD_TP146036UK04ReasonTemplateId templateIdField;
        ...
        public COCD_TP146036UK04Reason() {
        ...
        public COCD_TP146036UK04ReasonSeperatableInd seperatableInd {
            get {
        ...
        public COCD_TP146036UK04ReasonTemplateId templateId {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(COCD_TP146036UK04Reason));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current COCD_TP146036UK04Reason object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an COCD_TP146036UK04Reason object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output COCD_TP146036UK04Reason object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out COCD_TP146036UK04Reason obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146036UK04Reason);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out COCD_TP146036UK04Reason obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static COCD_TP146036UK04Reason Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((COCD_TP146036UK04Reason)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current COCD_TP146036UK04Reason object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an COCD_TP146036UK04Reason object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output COCD_TP146036UK04Reason object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out COCD_TP146036UK04Reason obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146036UK04Reason);
            try {
        ...
        public static bool LoadFromFile(string fileName, out COCD_TP146036UK04Reason obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static COCD_TP146036UK04Reason LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this COCD_TP146036UK04Reason object
        /// </summary>
        public virtual COCD_TP146036UK04Reason Clone() {
            return ((COCD_TP146036UK04Reason)(this.MemberwiseClone()));
        }
        #endregion
    }
}
