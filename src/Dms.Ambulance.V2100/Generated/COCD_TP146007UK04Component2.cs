...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="COCD_TP146007UK04.Component2", Namespace="urn:hl7-org:v3")]
    public partial class COCD_TP146007UK04Component2 {
        
        private TemplateContent contentIdField;
        
        private COCD_TP146007UK04Component2SeperatableInd seperatableIndField;
        
        private COCD_TP146007UK04Component2TemplateId templateIdField;
        ...
        public COCD_TP146007UK04Component2() {
        ...
        public COCD_TP146007UK04Component2SeperatableInd seperatableInd {
            get {
        ...
        public COCD_TP146007UK04Component2TemplateId templateId {
            get {
        ...
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147065UK01.AssessmentEventRef", typeof(COCD_TP147065UK01AssessmentEventRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147066UK01.PhysicalWellBeingRef", typeof(COCD_TP147066UK01PhysicalWellBeingRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147067UK01.ActivityOfDailyLivingRef", typeof(COCD_TP147067UK01ActivityOfDailyLivingRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147068UK01.HousingRef", typeof(COCD_TP147068UK01HousingRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147069UK01.MobilityRef", typeof(COCD_TP147069UK01MobilityRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147070UK01.MentalEmotionalWellBeingRef", typeof(COCD_TP147070UK01MentalEmotionalWellBeingRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147071UK01.FinancesRef", typeof(COCD_TP147071UK01FinancesRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147072UK01.SecurityAbuseDiscriminationRef", typeof(COCD_TP147072UK01SecurityAbuseDiscriminationRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147073UK01.EmploymentRef", typeof(COCD_TP147073UK01EmploymentRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147074UK01.AccommodationRef", typeof(COCD_TP147074UK01AccommodationRef))]
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147075UK01.CarePlanRef", typeof(COCD_TP147075UK01CarePlanRef))]
        public object Item {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(COCD_TP146007UK04Component2));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current COCD_TP146007UK04Component2 object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an COCD_TP146007UK04Component2 object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output COCD_TP146007UK04Component2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out COCD_TP146007UK04Component2 obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146007UK04Component2);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out COCD_TP146007UK04Component2 obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static COCD_TP146007UK04Component2 Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((COCD_TP146007UK04Component2)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current COCD_TP146007UK04Component2 object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an COCD_TP146007UK04Component2 object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output COCD_TP146007UK04Component2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out COCD_TP146007UK04Component2 obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146007UK04Component2);
            try {
        ...
        public static bool LoadFromFile(string fileName, out COCD_TP146007UK04Component2 obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static COCD_TP146007UK04Component2 LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this COCD_TP146007UK04Component2 object
        /// </summary>
        public virtual COCD_TP146007UK04Component2 Clone() {
            return ((COCD_TP146007UK04Component2)(this.MemberwiseClone()));
        }
        #endregion
    }
}
