...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="POCD_MT000002UK01.ObservationMedia", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000002UK01.ObservationMedia", Namespace="urn:hl7-org:v3")]
    public partial class POCD_MT000002UK01ObservationMedia {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(POCD_MT000002UK01ObservationMedia));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current POCD_MT000002UK01ObservationMedia object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an POCD_MT000002UK01ObservationMedia object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output POCD_MT000002UK01ObservationMedia object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out POCD_MT000002UK01ObservationMedia obj, out System.Exception exception) {
            exception = null;
            obj = default(POCD_MT000002UK01ObservationMedia);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out POCD_MT000002UK01ObservationMedia obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static POCD_MT000002UK01ObservationMedia Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((POCD_MT000002UK01ObservationMedia)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current POCD_MT000002UK01ObservationMedia object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an POCD_MT000002UK01ObservationMedia object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output POCD_MT000002UK01ObservationMedia object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out POCD_MT000002UK01ObservationMedia obj, out System.Exception exception) {
            exception = null;
            obj = default(POCD_MT000002UK01ObservationMedia);
            try {
        ...
        public static bool LoadFromFile(string fileName, out POCD_MT000002UK01ObservationMedia obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static POCD_MT000002UK01ObservationMedia LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this POCD_MT000002UK01ObservationMedia object
        /// </summary>
        public virtual POCD_MT000002UK01ObservationMedia Clone() {
            return ((POCD_MT000002UK01ObservationMedia)(this.MemberwiseClone()));
        }
        #endregion
    }
}
