...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="COCD_TP146005UK05.Component", Namespace="urn:hl7-org:v3")]
    public partial class COCD_TP146005UK05Component {
        
        private TemplateContent contentIdField;
        
        private COCD_TP146005UK05ComponentSeperatableInd seperatableIndField;
        
        private COCD_TP146005UK05ComponentTemplateId templateIdField;
        ...
        public COCD_TP146005UK05Component() {
        ...
        public COCD_TP146005UK05ComponentSeperatableInd seperatableInd {
            get {
        ...
        public COCD_TP146005UK05ComponentTemplateId templateId {
            get {
        ...
        [System.Xml.Serialization.XmlElementAttribute("COCD_TP147100UK01.AssessmentRef", typeof(COCD_TP147100UK01AssessmentRef))]
        public object Item {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(COCD_TP146005UK05Component));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current COCD_TP146005UK05Component object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an COCD_TP146005UK05Component object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output COCD_TP146005UK05Component object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out COCD_TP146005UK05Component obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146005UK05Component);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out COCD_TP146005UK05Component obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static COCD_TP146005UK05Component Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((COCD_TP146005UK05Component)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current COCD_TP146005UK05Component object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an COCD_TP146005UK05Component object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output COCD_TP146005UK05Component object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out COCD_TP146005UK05Component obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146005UK05Component);
            try {
        ...
        public static bool LoadFromFile(string fileName, out COCD_TP146005UK05Component obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static COCD_TP146005UK05Component LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this COCD_TP146005UK05Component object
        /// </summary>
        public virtual COCD_TP146005UK05Component Clone() {
            return ((COCD_TP146005UK05Component)(this.MemberwiseClone()));
        }
        #endregion
    }
}
