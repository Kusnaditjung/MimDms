...
namespace Dms.Ambulance.V2100 {
    ...
    public partial class ST : ED {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ST));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ST object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ST object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ST object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ST obj, out System.Exception exception) {
            exception = null;
            obj = default(ST);
            try {
                obj = Deserialize(xml);
        ...
        public static bool Deserialize(string xml, out ST obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ST Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ST)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ST object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ST object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ST object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ST obj, out System.Exception exception) {
            exception = null;
            obj = default(ST);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ST obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ST LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ST object
        /// </summary>
        public virtual ST Clone() {
            return ((ST)(this.MemberwiseClone()));
        }
        #endregion
    }
}
