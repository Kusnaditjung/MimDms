...
namespace Mim.V3109 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="PORX_IN480101UK05.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("PORX_IN480101UK05", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class PORX_IN480101UK05Message {
        ...
        private PORX_IN480101UK05ControlActEvent controlActEventField;
        ...
        public PORX_IN480101UK05Message() {
        ...
        public PORX_IN480101UK05ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PORX_IN480101UK05Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PORX_IN480101UK05Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PORX_IN480101UK05Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PORX_IN480101UK05Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PORX_IN480101UK05Message obj, out System.Exception exception) {
            exception = null;
            obj = default(PORX_IN480101UK05Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out PORX_IN480101UK05Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PORX_IN480101UK05Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PORX_IN480101UK05Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PORX_IN480101UK05Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PORX_IN480101UK05Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PORX_IN480101UK05Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PORX_IN480101UK05Message obj, out System.Exception exception) {
            exception = null;
            obj = default(PORX_IN480101UK05Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PORX_IN480101UK05Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PORX_IN480101UK05Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PORX_IN480101UK05Message object
        /// </summary>
        public virtual PORX_IN480101UK05Message Clone() {
            return ((PORX_IN480101UK05Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
