...
namespace Mim.V3109 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="QUQI_IN010000UK14.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("QUQI_IN010000UK14", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class QUQI_IN010000UK14Message {
        ...
        private QUQI_IN010000UK14ControlActEvent controlActEventField;
        ...
        public QUQI_IN010000UK14Message() {
        ...
        public QUQI_IN010000UK14ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(QUQI_IN010000UK14Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current QUQI_IN010000UK14Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an QUQI_IN010000UK14Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output QUQI_IN010000UK14Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out QUQI_IN010000UK14Message obj, out System.Exception exception) {
            exception = null;
            obj = default(QUQI_IN010000UK14Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out QUQI_IN010000UK14Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static QUQI_IN010000UK14Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((QUQI_IN010000UK14Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current QUQI_IN010000UK14Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an QUQI_IN010000UK14Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output QUQI_IN010000UK14Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out QUQI_IN010000UK14Message obj, out System.Exception exception) {
            exception = null;
            obj = default(QUQI_IN010000UK14Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out QUQI_IN010000UK14Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static QUQI_IN010000UK14Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this QUQI_IN010000UK14Message object
        /// </summary>
        public virtual QUQI_IN010000UK14Message Clone() {
            return ((QUQI_IN010000UK14Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
