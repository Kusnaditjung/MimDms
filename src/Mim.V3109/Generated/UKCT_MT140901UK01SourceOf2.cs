...
namespace Mim.V3109 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="UKCT_MT140901UK01.SourceOf2", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("UKCT_MT140901UK01.SourceOf2", Namespace="urn:hl7-org:v3")]
    public partial class UKCT_MT140901UK01SourceOf2 {
        
        private INT sequenceNumberField;
        
        private BL seperatableIndField;
        
        private UKCT_MT140901UK01SourceOf2TemplateId templateIdField;
        ...
        public UKCT_MT140901UK01SourceOf2() {
        ...
        public UKCT_MT140901UK01SourceOf2TemplateId templateId {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(UKCT_MT140901UK01SourceOf2));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current UKCT_MT140901UK01SourceOf2 object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an UKCT_MT140901UK01SourceOf2 object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output UKCT_MT140901UK01SourceOf2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out UKCT_MT140901UK01SourceOf2 obj, out System.Exception exception) {
            exception = null;
            obj = default(UKCT_MT140901UK01SourceOf2);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out UKCT_MT140901UK01SourceOf2 obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static UKCT_MT140901UK01SourceOf2 Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((UKCT_MT140901UK01SourceOf2)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current UKCT_MT140901UK01SourceOf2 object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an UKCT_MT140901UK01SourceOf2 object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output UKCT_MT140901UK01SourceOf2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out UKCT_MT140901UK01SourceOf2 obj, out System.Exception exception) {
            exception = null;
            obj = default(UKCT_MT140901UK01SourceOf2);
            try {
        ...
        public static bool LoadFromFile(string fileName, out UKCT_MT140901UK01SourceOf2 obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static UKCT_MT140901UK01SourceOf2 LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this UKCT_MT140901UK01SourceOf2 object
        /// </summary>
        public virtual UKCT_MT140901UK01SourceOf2 Clone() {
            return ((UKCT_MT140901UK01SourceOf2)(this.MemberwiseClone()));
        }
        #endregion
    }
}
