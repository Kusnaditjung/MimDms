...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="RCMR_MT030101UK04.RegistrationStatement", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("RCMR_MT030101UK04.RegistrationStatement", Namespace="urn:hl7-org:v3")]
    public partial class RCMR_MT030101UK04RegistrationStatement {
        ...
        private RCMR_MT030101UK04ResponsibleParty2 responsiblePartyField;
        ...
        public RCMR_MT030101UK04RegistrationStatement() {
        ...
        public RCMR_MT030101UK04ResponsibleParty2 responsibleParty {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(RCMR_MT030101UK04RegistrationStatement));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current RCMR_MT030101UK04RegistrationStatement object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an RCMR_MT030101UK04RegistrationStatement object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output RCMR_MT030101UK04RegistrationStatement object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out RCMR_MT030101UK04RegistrationStatement obj, out System.Exception exception) {
            exception = null;
            obj = default(RCMR_MT030101UK04RegistrationStatement);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out RCMR_MT030101UK04RegistrationStatement obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static RCMR_MT030101UK04RegistrationStatement Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((RCMR_MT030101UK04RegistrationStatement)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current RCMR_MT030101UK04RegistrationStatement object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an RCMR_MT030101UK04RegistrationStatement object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output RCMR_MT030101UK04RegistrationStatement object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out RCMR_MT030101UK04RegistrationStatement obj, out System.Exception exception) {
            exception = null;
            obj = default(RCMR_MT030101UK04RegistrationStatement);
            try {
        ...
        public static bool LoadFromFile(string fileName, out RCMR_MT030101UK04RegistrationStatement obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static RCMR_MT030101UK04RegistrationStatement LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this RCMR_MT030101UK04RegistrationStatement object
        /// </summary>
        public virtual RCMR_MT030101UK04RegistrationStatement Clone() {
            return ((RCMR_MT030101UK04RegistrationStatement)(this.MemberwiseClone()));
        }
        #endregion
    }
}
