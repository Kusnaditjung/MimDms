...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="QUPA_IN050000UK32.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("QUPA_IN050000UK32", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class QUPA_IN050000UK32Message {
        ...
        private QUPA_IN050000UK32ControlActEvent controlActEventField;
        ...
        public QUPA_IN050000UK32Message() {
        ...
        public QUPA_IN050000UK32ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(QUPA_IN050000UK32Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current QUPA_IN050000UK32Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an QUPA_IN050000UK32Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output QUPA_IN050000UK32Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out QUPA_IN050000UK32Message obj, out System.Exception exception) {
            exception = null;
            obj = default(QUPA_IN050000UK32Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out QUPA_IN050000UK32Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static QUPA_IN050000UK32Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((QUPA_IN050000UK32Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current QUPA_IN050000UK32Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an QUPA_IN050000UK32Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output QUPA_IN050000UK32Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out QUPA_IN050000UK32Message obj, out System.Exception exception) {
            exception = null;
            obj = default(QUPA_IN050000UK32Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out QUPA_IN050000UK32Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static QUPA_IN050000UK32Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this QUPA_IN050000UK32Message object
        /// </summary>
        public virtual QUPA_IN050000UK32Message Clone() {
            return ((QUPA_IN050000UK32Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
