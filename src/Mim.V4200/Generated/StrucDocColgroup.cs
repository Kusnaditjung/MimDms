...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlRootAttribute("StrucDoc.Colgroup", Namespace="urn:hl7-org:v3")]
    public partial class StrucDocColgroup {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(StrucDocColgroup));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current StrucDocColgroup object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an StrucDocColgroup object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output StrucDocColgroup object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out StrucDocColgroup obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocColgroup);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out StrucDocColgroup obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static StrucDocColgroup Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((StrucDocColgroup)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current StrucDocColgroup object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an StrucDocColgroup object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output StrucDocColgroup object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out StrucDocColgroup obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocColgroup);
            try {
        ...
        public static bool LoadFromFile(string fileName, out StrucDocColgroup obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static StrucDocColgroup LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this StrucDocColgroup object
        /// </summary>
        public virtual StrucDocColgroup Clone() {
            return ((StrucDocColgroup)(this.MemberwiseClone()));
        }
        #endregion
    }
}
