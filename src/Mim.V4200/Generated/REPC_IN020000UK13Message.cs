...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="REPC_IN020000UK13.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("REPC_IN020000UK13", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class REPC_IN020000UK13Message {
        ...
        private REPC_IN020000UK13ControlActEvent controlActEventField;
        ...
        public REPC_IN020000UK13Message() {
        ...
        public REPC_IN020000UK13ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(REPC_IN020000UK13Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current REPC_IN020000UK13Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an REPC_IN020000UK13Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output REPC_IN020000UK13Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out REPC_IN020000UK13Message obj, out System.Exception exception) {
            exception = null;
            obj = default(REPC_IN020000UK13Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out REPC_IN020000UK13Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static REPC_IN020000UK13Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((REPC_IN020000UK13Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current REPC_IN020000UK13Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an REPC_IN020000UK13Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output REPC_IN020000UK13Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out REPC_IN020000UK13Message obj, out System.Exception exception) {
            exception = null;
            obj = default(REPC_IN020000UK13Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out REPC_IN020000UK13Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static REPC_IN020000UK13Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this REPC_IN020000UK13Message object
        /// </summary>
        public virtual REPC_IN020000UK13Message Clone() {
            return ((REPC_IN020000UK13Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
