...
namespace Mim.V6301 {
    ...
    public abstract partial class QTY : ANY {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(QTY));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current QTY object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an QTY object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output QTY object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out QTY obj, out System.Exception exception) {
            exception = null;
            obj = default(QTY);
            try {
                obj = Deserialize(xml);
        ...
        public static bool Deserialize(string xml, out QTY obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static QTY Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((QTY)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current QTY object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an QTY object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output QTY object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out QTY obj, out System.Exception exception) {
            exception = null;
            obj = default(QTY);
            try {
        ...
        public static bool LoadFromFile(string fileName, out QTY obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static QTY LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this QTY object
        /// </summary>
        public virtual QTY Clone() {
