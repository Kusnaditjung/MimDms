...
namespace Mim.V6301 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="PRPA_MT000001UK03.AppointmentRequest", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("PRPA_MT000001UK03.AppointmentRequest", Namespace="urn:hl7-org:v3")]
    public partial class PRPA_MT000001UK03AppointmentRequest {
        ...
        private PRPA_MT000001UK03Component10 component3Field;
        
        private PRPA_MT000001UK03Component4 component4Field;
        
        private PRPA_MT000001UK03InFulfillmentOf fulfillmentField;
        ...
        public PRPA_MT000001UK03AppointmentRequest() {
        ...
        public PRPA_MT000001UK03Component10 component3 {
            get {
        ...
        public PRPA_MT000001UK03Component4 component4 {
            get {
        ...
        public PRPA_MT000001UK03InFulfillmentOf fulfillment {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PRPA_MT000001UK03AppointmentRequest));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PRPA_MT000001UK03AppointmentRequest object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PRPA_MT000001UK03AppointmentRequest object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PRPA_MT000001UK03AppointmentRequest object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PRPA_MT000001UK03AppointmentRequest obj, out System.Exception exception) {
            exception = null;
            obj = default(PRPA_MT000001UK03AppointmentRequest);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out PRPA_MT000001UK03AppointmentRequest obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PRPA_MT000001UK03AppointmentRequest Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PRPA_MT000001UK03AppointmentRequest)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PRPA_MT000001UK03AppointmentRequest object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PRPA_MT000001UK03AppointmentRequest object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PRPA_MT000001UK03AppointmentRequest object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PRPA_MT000001UK03AppointmentRequest obj, out System.Exception exception) {
            exception = null;
            obj = default(PRPA_MT000001UK03AppointmentRequest);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PRPA_MT000001UK03AppointmentRequest obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PRPA_MT000001UK03AppointmentRequest LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PRPA_MT000001UK03AppointmentRequest object
        /// </summary>
        public virtual PRPA_MT000001UK03AppointmentRequest Clone() {
            return ((PRPA_MT000001UK03AppointmentRequest)(this.MemberwiseClone()));
        }
        #endregion
    }
}
