...
namespace Mim.V6301 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="COCD_TP146027UK04.Reference", Namespace="urn:hl7-org:v3")]
    public partial class COCD_TP146027UK04Reference {
        
        private TemplateContent contentIdField;
        
        private BL seperatableIndField;
        
        private COCD_TP146027UK04ReferenceTemplateId templateIdField;
        ...
        public COCD_TP146027UK04Reference() {
        ...
        public COCD_TP146027UK04ReferenceTemplateId templateId {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(COCD_TP146027UK04Reference));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current COCD_TP146027UK04Reference object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an COCD_TP146027UK04Reference object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output COCD_TP146027UK04Reference object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out COCD_TP146027UK04Reference obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146027UK04Reference);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out COCD_TP146027UK04Reference obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static COCD_TP146027UK04Reference Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((COCD_TP146027UK04Reference)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current COCD_TP146027UK04Reference object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an COCD_TP146027UK04Reference object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output COCD_TP146027UK04Reference object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out COCD_TP146027UK04Reference obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146027UK04Reference);
            try {
        ...
        public static bool LoadFromFile(string fileName, out COCD_TP146027UK04Reference obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static COCD_TP146027UK04Reference LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this COCD_TP146027UK04Reference object
        /// </summary>
        public virtual COCD_TP146027UK04Reference Clone() {
            return ((COCD_TP146027UK04Reference)(this.MemberwiseClone()));
        }
        #endregion
    }
}
