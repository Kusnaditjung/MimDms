...
namespace Mim.V6301 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="PRSC_IN140000UK08.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("PRSC_IN140000UK08", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class PRSC_IN140000UK08Message {
        ...
        private PRSC_IN140000UK08ControlActEvent controlActEventField;
        ...
        public PRSC_IN140000UK08Message() {
        ...
        public PRSC_IN140000UK08ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PRSC_IN140000UK08Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PRSC_IN140000UK08Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PRSC_IN140000UK08Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PRSC_IN140000UK08Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PRSC_IN140000UK08Message obj, out System.Exception exception) {
            exception = null;
            obj = default(PRSC_IN140000UK08Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out PRSC_IN140000UK08Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PRSC_IN140000UK08Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PRSC_IN140000UK08Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PRSC_IN140000UK08Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PRSC_IN140000UK08Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PRSC_IN140000UK08Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PRSC_IN140000UK08Message obj, out System.Exception exception) {
            exception = null;
            obj = default(PRSC_IN140000UK08Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PRSC_IN140000UK08Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PRSC_IN140000UK08Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PRSC_IN140000UK08Message object
        /// </summary>
        public virtual PRSC_IN140000UK08Message Clone() {
            return ((PRSC_IN140000UK08Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
