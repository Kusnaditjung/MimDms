...
namespace Mim.V6301 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="REPC_IN130005UK01.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("REPC_IN130005UK01", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class REPC_IN130005UK01Message {
        ...
        private REPC_IN130005UK01ControlActEvent controlActEventField;
        ...
        public REPC_IN130005UK01Message() {
        ...
        public REPC_IN130005UK01ControlActEvent ControlActEvent {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(REPC_IN130005UK01Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current REPC_IN130005UK01Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an REPC_IN130005UK01Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output REPC_IN130005UK01Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out REPC_IN130005UK01Message obj, out System.Exception exception) {
            exception = null;
            obj = default(REPC_IN130005UK01Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out REPC_IN130005UK01Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static REPC_IN130005UK01Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((REPC_IN130005UK01Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current REPC_IN130005UK01Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an REPC_IN130005UK01Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output REPC_IN130005UK01Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out REPC_IN130005UK01Message obj, out System.Exception exception) {
            exception = null;
            obj = default(REPC_IN130005UK01Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out REPC_IN130005UK01Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static REPC_IN130005UK01Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this REPC_IN130005UK01Message object
        /// </summary>
        public virtual REPC_IN130005UK01Message Clone() {
            return ((REPC_IN130005UK01Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
