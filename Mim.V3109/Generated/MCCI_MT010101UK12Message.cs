...
namespace Mim.V3109 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="MCCI_MT010101UK12.Message", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("Message", Namespace="urn:hl7-org:v3", IsNullable=false)]
    public partial class MCCI_MT010101UK12Message {
        ...
        public MCCI_MT010101UK12Message() {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(MCCI_MT010101UK12Message));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current MCCI_MT010101UK12Message object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an MCCI_MT010101UK12Message object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output MCCI_MT010101UK12Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out MCCI_MT010101UK12Message obj, out System.Exception exception) {
            exception = null;
            obj = default(MCCI_MT010101UK12Message);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out MCCI_MT010101UK12Message obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static MCCI_MT010101UK12Message Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((MCCI_MT010101UK12Message)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current MCCI_MT010101UK12Message object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an MCCI_MT010101UK12Message object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output MCCI_MT010101UK12Message object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out MCCI_MT010101UK12Message obj, out System.Exception exception) {
            exception = null;
            obj = default(MCCI_MT010101UK12Message);
            try {
        ...
        public static bool LoadFromFile(string fileName, out MCCI_MT010101UK12Message obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static MCCI_MT010101UK12Message LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this MCCI_MT010101UK12Message object
        /// </summary>
        public virtual MCCI_MT010101UK12Message Clone() {
            return ((MCCI_MT010101UK12Message)(this.MemberwiseClone()));
        }
        #endregion
    }
}
