...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlRootAttribute("StrucDoc.Table", Namespace="urn:hl7-org:v3")]
    public partial class StrucDocTable {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(StrucDocTable));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current StrucDocTable object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an StrucDocTable object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output StrucDocTable object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out StrucDocTable obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocTable);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out StrucDocTable obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static StrucDocTable Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((StrucDocTable)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current StrucDocTable object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an StrucDocTable object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output StrucDocTable object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out StrucDocTable obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocTable);
            try {
        ...
        public static bool LoadFromFile(string fileName, out StrucDocTable obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static StrucDocTable LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this StrucDocTable object
        /// </summary>
        public virtual StrucDocTable Clone() {
            return ((StrucDocTable)(this.MemberwiseClone()));
        }
        #endregion
    }
}
