...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlRootAttribute("StrucDoc.Th", Namespace="urn:hl7-org:v3")]
    public partial class StrucDocTh {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(StrucDocTh));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current StrucDocTh object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an StrucDocTh object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output StrucDocTh object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out StrucDocTh obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocTh);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out StrucDocTh obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static StrucDocTh Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((StrucDocTh)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current StrucDocTh object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an StrucDocTh object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output StrucDocTh object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out StrucDocTh obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocTh);
            try {
        ...
        public static bool LoadFromFile(string fileName, out StrucDocTh obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static StrucDocTh LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this StrucDocTh object
        /// </summary>
        public virtual StrucDocTh Clone() {
            return ((StrucDocTh)(this.MemberwiseClone()));
        }
        #endregion
    }
}
