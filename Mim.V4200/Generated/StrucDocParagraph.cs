...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlRootAttribute("StrucDoc.Paragraph", Namespace="urn:hl7-org:v3")]
    public partial class StrucDocParagraph {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(StrucDocParagraph));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current StrucDocParagraph object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an StrucDocParagraph object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output StrucDocParagraph object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out StrucDocParagraph obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocParagraph);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out StrucDocParagraph obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static StrucDocParagraph Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((StrucDocParagraph)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current StrucDocParagraph object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an StrucDocParagraph object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output StrucDocParagraph object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out StrucDocParagraph obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocParagraph);
            try {
        ...
        public static bool LoadFromFile(string fileName, out StrucDocParagraph obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static StrucDocParagraph LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this StrucDocParagraph object
        /// </summary>
        public virtual StrucDocParagraph Clone() {
            return ((StrucDocParagraph)(this.MemberwiseClone()));
        }
        #endregion
    }
}
