...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlRootAttribute("StrucDoc.Item", Namespace="urn:hl7-org:v3")]
    public partial class StrucDocItem {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(StrucDocItem));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current StrucDocItem object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an StrucDocItem object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output StrucDocItem object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out StrucDocItem obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocItem);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out StrucDocItem obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static StrucDocItem Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((StrucDocItem)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current StrucDocItem object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an StrucDocItem object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output StrucDocItem object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out StrucDocItem obj, out System.Exception exception) {
            exception = null;
            obj = default(StrucDocItem);
            try {
        ...
        public static bool LoadFromFile(string fileName, out StrucDocItem obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static StrucDocItem LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this StrucDocItem object
        /// </summary>
        public virtual StrucDocItem Clone() {
            return ((StrucDocItem)(this.MemberwiseClone()));
        }
        #endregion
    }
}
