...
namespace Mim.V4200 {
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(BatchResponse1))]
    ...
    public partial class BatchResponse {
        ...
        private BatchManifestItem_Type2[] manifestItemField;
        ...
        public BatchManifestItem_Type2[] manifestItem {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(BatchResponse));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current BatchResponse object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an BatchResponse object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output BatchResponse object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out BatchResponse obj, out System.Exception exception) {
            exception = null;
            obj = default(BatchResponse);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out BatchResponse obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static BatchResponse Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((BatchResponse)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current BatchResponse object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an BatchResponse object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output BatchResponse object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out BatchResponse obj, out System.Exception exception) {
            exception = null;
            obj = default(BatchResponse);
            try {
        ...
        public static bool LoadFromFile(string fileName, out BatchResponse obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static BatchResponse LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this BatchResponse object
        /// </summary>
        public virtual BatchResponse Clone() {
            return ((BatchResponse)(this.MemberwiseClone()));
        }
        #endregion
    }
}
