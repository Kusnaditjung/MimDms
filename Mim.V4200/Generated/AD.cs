...
namespace Mim.V4200 {
    ...
    public partial class AD : ANY {
        ...
        [System.Xml.Serialization.XmlElementAttribute("additionalLocator", typeof(ADAdditionalLocator))]
        [System.Xml.Serialization.XmlElementAttribute("addressKey", typeof(ADAddressKey))]
        [System.Xml.Serialization.XmlElementAttribute("carrier", typeof(ADCarrier))]
        [System.Xml.Serialization.XmlElementAttribute("censusTract", typeof(ADCensusTract))]
        [System.Xml.Serialization.XmlElementAttribute("city", typeof(ADCity))]
        [System.Xml.Serialization.XmlElementAttribute("country", typeof(ADCountry))]
        [System.Xml.Serialization.XmlElementAttribute("county", typeof(ADCounty))]
        [System.Xml.Serialization.XmlElementAttribute("delimiter", typeof(ADDelimiter))]
        [System.Xml.Serialization.XmlElementAttribute("desc", typeof(ADDesc))]
        [System.Xml.Serialization.XmlElementAttribute("direction", typeof(ADDirection))]
        [System.Xml.Serialization.XmlElementAttribute("houseNumber", typeof(ADHouseNumber))]
        [System.Xml.Serialization.XmlElementAttribute("houseNumberNumeric", typeof(ADHouseNumberNumeric))]
        [System.Xml.Serialization.XmlElementAttribute("postalCode", typeof(ADPostalCode))]
        [System.Xml.Serialization.XmlElementAttribute("state", typeof(ADState))]
        [System.Xml.Serialization.XmlElementAttribute("streetAddressLine", typeof(ADStreetAddressLine))]
        [System.Xml.Serialization.XmlElementAttribute("streetName", typeof(ADStreetName))]
        [System.Xml.Serialization.XmlElementAttribute("streetNameBase", typeof(ADStreetNameBase))]
        [System.Xml.Serialization.XmlElementAttribute("streetNameType", typeof(ADStreetNameType))]
        [System.Xml.Serialization.XmlElementAttribute("unitID", typeof(ADUnitID))]
        [System.Xml.Serialization.XmlElementAttribute("unitType", typeof(ADUnitType))]
        public object[] Items {
            get {
