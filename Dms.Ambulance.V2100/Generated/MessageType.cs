...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="Message.Type", Namespace="NPFIT:HL7:Localisation")]
    [System.Xml.Serialization.XmlRootAttribute("messageType", Namespace="NPFIT:HL7:Localisation", IsNullable=false)]
    public partial class MessageType : II {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this MessageType object
        /// </summary>
        public virtual MessageType Clone() {
            return ((MessageType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
