...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="COCD_TP146006UK04.Subject", Namespace="urn:hl7-org:v3")]
    public partial class COCD_TP146006UK04Subject {
        
        private TemplateContent contentIdField;
        
        private COCD_TP146006UK04SubjectSeperatableInd seperatableIndField;
        
        private COCD_TP146006UK04SubjectTemplateId templateIdField;
        ...
        public COCD_TP146006UK04Subject() {
        ...
        public COCD_TP146006UK04SubjectSeperatableInd seperatableInd {
            get {
        ...
        public COCD_TP146006UK04SubjectTemplateId templateId {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(COCD_TP146006UK04Subject));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current COCD_TP146006UK04Subject object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an COCD_TP146006UK04Subject object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output COCD_TP146006UK04Subject object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out COCD_TP146006UK04Subject obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146006UK04Subject);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out COCD_TP146006UK04Subject obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static COCD_TP146006UK04Subject Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((COCD_TP146006UK04Subject)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current COCD_TP146006UK04Subject object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an COCD_TP146006UK04Subject object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output COCD_TP146006UK04Subject object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out COCD_TP146006UK04Subject obj, out System.Exception exception) {
            exception = null;
            obj = default(COCD_TP146006UK04Subject);
            try {
        ...
        public static bool LoadFromFile(string fileName, out COCD_TP146006UK04Subject obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static COCD_TP146006UK04Subject LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this COCD_TP146006UK04Subject object
        /// </summary>
        public virtual COCD_TP146006UK04Subject Clone() {
            return ((COCD_TP146006UK04Subject)(this.MemberwiseClone()));
        }
        #endregion
    }
}
