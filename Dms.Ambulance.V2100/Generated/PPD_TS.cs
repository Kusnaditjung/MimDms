...
namespace Dms.Ambulance.V2100 {
    ...
    public partial class PPD_TS : TS {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PPD_TS));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PPD_TS object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PPD_TS object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PPD_TS object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PPD_TS obj, out System.Exception exception) {
            exception = null;
            obj = default(PPD_TS);
            try {
                obj = Deserialize(xml);
        ...
        public static bool Deserialize(string xml, out PPD_TS obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PPD_TS Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PPD_TS)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PPD_TS object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PPD_TS object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PPD_TS object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PPD_TS obj, out System.Exception exception) {
            exception = null;
            obj = default(PPD_TS);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PPD_TS obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PPD_TS LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PPD_TS object
        /// </summary>
        public virtual PPD_TS Clone() {
            return ((PPD_TS)(this.MemberwiseClone()));
        }
        #endregion
    }
}
