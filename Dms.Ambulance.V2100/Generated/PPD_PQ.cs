...
namespace Dms.Ambulance.V2100 {
    ...
    public partial class PPD_PQ : PQ {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PPD_PQ));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PPD_PQ object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PPD_PQ object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PPD_PQ object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PPD_PQ obj, out System.Exception exception) {
            exception = null;
            obj = default(PPD_PQ);
            try {
                obj = Deserialize(xml);
        ...
        public static bool Deserialize(string xml, out PPD_PQ obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PPD_PQ Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PPD_PQ)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PPD_PQ object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PPD_PQ object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PPD_PQ object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PPD_PQ obj, out System.Exception exception) {
            exception = null;
            obj = default(PPD_PQ);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PPD_PQ obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PPD_PQ LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PPD_PQ object
        /// </summary>
        public virtual PPD_PQ Clone() {
            return ((PPD_PQ)(this.MemberwiseClone()));
        }
        #endregion
    }
}
