...
namespace Dms.Ambulance.V2100 {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(TypeName="POCD_MT000002UK01.Act", Namespace="urn:hl7-org:v3")]
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000002UK01.Act", Namespace="urn:hl7-org:v3")]
    public partial class POCD_MT000002UK01Act {
        ...
        private CDNPfITCDAUrl textField;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(POCD_MT000002UK01Act));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current POCD_MT000002UK01Act object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an POCD_MT000002UK01Act object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output POCD_MT000002UK01Act object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out POCD_MT000002UK01Act obj, out System.Exception exception) {
            exception = null;
            obj = default(POCD_MT000002UK01Act);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out POCD_MT000002UK01Act obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static POCD_MT000002UK01Act Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((POCD_MT000002UK01Act)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current POCD_MT000002UK01Act object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an POCD_MT000002UK01Act object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output POCD_MT000002UK01Act object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out POCD_MT000002UK01Act obj, out System.Exception exception) {
            exception = null;
            obj = default(POCD_MT000002UK01Act);
            try {
        ...
        public static bool LoadFromFile(string fileName, out POCD_MT000002UK01Act obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static POCD_MT000002UK01Act LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this POCD_MT000002UK01Act object
        /// </summary>
        public virtual POCD_MT000002UK01Act Clone() {
            return ((POCD_MT000002UK01Act)(this.MemberwiseClone()));
        }
        #endregion
    }
}
